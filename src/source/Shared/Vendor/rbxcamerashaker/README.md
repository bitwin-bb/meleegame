...
**Ported for Wally by ArakoDev.**  
Originally created by [Stephen Leitnick](https://github.com/Sleitnick).
Original repository: [sleitnick/RbxCameraShaker](https://github.com/Sleitnick/RbxCameraShaker).
